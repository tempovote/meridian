    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "TreeSitterPython", package: "Grammars"),
                .product(name: "TreeSitterYaml", package: "Grammars"),
                .product(name: "TreeSitterToml", package: "Grammars"),
                .product(name: "TreeSitterBash", package: "Grammars"),
                .product(name: "TreeSitterC", package: "Grammars"),
                .product(name: "TreeSitterCpp", package: "Grammars"),
                .product(name: "TreeSitterRust", package: "Grammars"),
                .product(name: "TreeSitterGo", package: "Grammars"),
            ],
